...
RIDGE_TEST_BUILD=$(mktemp -d "${TMPDIR:-/tmp}/ridge-atlas-real-build.XXXXXX")
...
xcrun swiftc -swift-version 6 -parse-as-library \
  ...
  "$RIDGE_PROJECT_ROOT/Tests/CartographyRealTests.swift" \
  -o "$RIDGE_TEST_BUILD/CartographyRealTests"
"$RIDGE_TEST_BUILD/CartographyRealTests" "$RIDGE_PROJECT_ROOT/ridge v3/Resources/RidgeData.bundle"
