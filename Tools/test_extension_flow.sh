...
xcrun swiftc -swift-version 6 -parse-as-library \
  ...
  "$RIDGE_PROJECT_ROOT/Tests/ExtensionFlowTests.swift" \
  -o "$RIDGE_TEST_BUILD/ExtensionFlowTests"
"$RIDGE_TEST_BUILD/ExtensionFlowTests" "$RIDGE_PROJECT_ROOT/ridge v3/Resources/RidgeData.bundle/regions/eryri-grid"
