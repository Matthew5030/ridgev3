...
RIDGE_TEST_BUILD=$(mktemp -d "${TMPDIR:-/tmp}/ridge-navigation-build.XXXXXX")
...
xcrun swiftc -swift-version 6 -parse-as-library \
  ...
  "$RIDGE_PROJECT_ROOT/Tests/TerrainNavigationTests.swift" \
  -o "$RIDGE_TEST_BUILD/TerrainNavigationTests"
"$RIDGE_TEST_BUILD/TerrainNavigationTests"
