...
RIDGE_TEST_BUILD=$(mktemp -d "${TMPDIR:-/tmp}/ridge-extension-build.XXXXXX")
...
xcrun swiftc -swift-version 6 -parse-as-library \
  ...
  "$RIDGE_PROJECT_ROOT/Tests/AreaExtensionTests.swift" \
  -o "$RIDGE_TEST_BUILD/AreaExtensionTests"
"$RIDGE_TEST_BUILD/AreaExtensionTests" "$RIDGE_PROJECT_ROOT/ridge v3/Resources/RidgeData.bundle"
