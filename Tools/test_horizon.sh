...
RIDGE_TEST_BUILD=$(mktemp -d "${TMPDIR:-/tmp}/ridge-horizon-build.XXXXXX")
...
xcrun swiftc -swift-version 6 -parse-as-library \
  ...
  "$RIDGE_PROJECT_ROOT/Tests/HorizonTests.swift" \
  -o "$RIDGE_TEST_BUILD/HorizonTests"
"$RIDGE_TEST_BUILD/HorizonTests" "$RIDGE_PROJECT_ROOT/ridge v3/Resources/RidgeData.bundle"
