...
RIDGE_TEST_BUILD=$(mktemp -d "${TMPDIR:-/tmp}/ridge-cartography-build.XXXXXX")
...
xcrun swiftc -swift-version 6 -parse-as-library \
  ...
  "$RIDGE_PROJECT_ROOT/Tests/CartographyAtlasTests.swift" \
  -o "$RIDGE_TEST_BUILD/CartographyAtlasTests"
"$RIDGE_TEST_BUILD/CartographyAtlasTests"
