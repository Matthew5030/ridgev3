...
RIDGE_TEST_BUILD=$(mktemp -d "${TMPDIR:-/tmp}/ridge-cartography-allocation.XXXXXX")
...
xcrun swiftc -swift-version 6 -parse-as-library \
  ...
  "$RIDGE_PROJECT_ROOT/Tests/CartographyAllocationTests.swift" \
  -o "$RIDGE_TEST_BUILD/CartographyAllocationTests"
"$RIDGE_TEST_BUILD/CartographyAllocationTests"
