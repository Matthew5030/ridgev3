...
RIDGE_TEST_BUILD=$(mktemp -d "${TMPDIR:-/tmp}/ridge-pack-build.XXXXXX")
...
xcrun swiftc -swift-version 6 -parse-as-library \
  ...
  "$RIDGE_PROJECT_ROOT/Tests/PackStoreTests.swift" \
  -o "$RIDGE_TEST_BUILD/PackStoreTests"
"$RIDGE_TEST_BUILD/PackStoreTests" "$RIDGE_PROJECT_ROOT/ridge v3/Resources/RidgeData.bundle"
