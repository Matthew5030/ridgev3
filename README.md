...
The app uses one normal atlas → tile selection → textured 3D route-planning flow. The former adaptive experiment has no entry point in Explore, Settings or app launch. Its prepared files remain on disk, but they do not extend the normal flow's available terrain coverage.
